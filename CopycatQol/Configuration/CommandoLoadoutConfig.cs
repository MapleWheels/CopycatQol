...
{
    public class CommandoLoadoutConfig : ConfigDataModel
    {
        public override void SetDefaults() => SectionName = "Commando_Loadout";
        ...
        public ConfigData<Info.ItemIds> InvSlot0Weapon { get; set; } = new ConfigData<Info.ItemIds>()
        {
            ...
            DefaultValue = Info.ItemIds.CommandoSuprRifle
        };
        ...
        public ConfigData<Info.ItemIds> InvSlot1Weapon { get; set; } = new ConfigData<Info.ItemIds>()
        {
            ...
            DefaultValue = Info.ItemIds.CommandoSuprPistol
        };
